...
public class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // For each item in the Array, create an {@link Book} object
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Extract the value for the image
                JSONObject currentNewsFieldsObject = currentNews.getJSONObject("fields");
                String imageUrl = "";
                if (currentNewsFieldsObject.has("thumbnail")) {
                    imageUrl = currentNewsFieldsObject.getString("thumbnail");
                }
                ...
                // Extract the value for the description
                String description = "";
                if (currentNewsFieldsObject.has("trailText")) {
                    description = currentNewsFieldsObject.getString("trailText");
                }
                // Extract the value for the date and time
                String dateTime="";
                if (currentNews.has("webPublicationDate")) {
                    dateTime = currentNews.getString("webPublicationDate");
                }
                // Create a new {@link News} object
                News news = new News(title, url, imageUrl, section, description, dateTime);
